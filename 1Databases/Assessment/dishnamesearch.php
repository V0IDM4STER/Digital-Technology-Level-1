...
if (isset($_POST['find_dishname']))
    
{

// Retrieves dish name and sanitises it
$dishname=test_input(mysqli_real_escape_string($dbconnect, $_POST['dishname']));
    
$showall_sql="SELECT * FROM `food_reviews` WHERE `Dish Name` LIKE '%$dishname%' ORDER BY `food_reviews`.`Dish Name` ASC";
